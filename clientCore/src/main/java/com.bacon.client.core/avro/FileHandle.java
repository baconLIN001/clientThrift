...
//     * @param param
     ...
     * @return
     */
//    public static FileUploadCode scannerReadFile(Param<OfflineParam> param, String filePath){
//        FileInputStream fileInputStream = null;
//        Scanner scanner = null;
//        String parameterString = JSON.toJSONString(param);
//        Processor processor = ProcessorFactory.createOfflineProcessor(parameterString);
//
//        AvroProducer avroProducer = new AvroProducer();
//        try {
...
//    }
    ...
    public static FileUploadCode scannerReadFile(String topic,OfflineParam offlineParam, String filePath){
        FileInputStream fileInputStream = null;
        Scanner scanner = null;
        String parameterString = JSON.toJSONString(offlineParam);
        Processor processor = ProcessorFactory.createOfflineProcessor(parameterString);
